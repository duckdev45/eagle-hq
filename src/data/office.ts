...
export const OFFICE_ITEMS: OfficeItemDef[] = [
  ...
  { id: 'desk-jared',     img: 'office_desk', x: 200, y: 415, w: 130, h: 108, solid: true },
  { id: 'chair-jared',    img: 'chair_blue',  x: 215, y: 500, w: 50,  h: 82,  solid: true },
  { id: 'desk-duck',      img: 'office_desk', x: 520, y: 415, w: 130, h: 108, solid: true },
  { id: 'chair-duck',     img: 'chair_black', x: 535, y: 500, w: 50,  h: 82,  solid: true },
  ...
  { id: 'locker',           img: 'locker',           x: 16,  y: 560, w: 184, h: 104, solid: true },
...
export const PUNCH_CLOCK: OfficeItemDef = {
  id: 'punch-clock', img: 'punch_clock', x: 860, y: 596, w: 52, h: 62, solid: true,
}
